    ...
    <section id="solucoes" class="w-full max-w-7xl mx-auto px-6 py-24 relative overflow-hidden">
        ...
        <div class="text-center mb-16 relative z-10 select-none sol-reveal">
            ...
            <h2 class="text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase tracking-tight leading-[1.05]" style="font-family: 'Orbitron', sans-serif;">
                Escolha o Plano Ideal<br>Para o <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">Seu Negócio</span>
            </h2>
            <p class="text-zinc-400 text-sm md:text-base max-w-2xl mx-auto leading-relaxed mt-5">
                Cada plano foi criado para resolver um problema real de negócio, do posicionamento online à automação operacional completa.
            </p>
        </div>
        ...
        <div class="sol-grid relative z-10">
            ...
            <div class="sol-card sol-reveal">
                ...
                <p class="sol-card__phrase">"Seu negócio merece ser encontrado e levado a sério."</p>
                <p class="sol-card__desc">Site premium desenvolvido sob medida para transmitir autoridade imediata e atrair novos clientes.</p>
                ...
                <ul class="sol-features">
                    ...
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        WhatsApp integrado para contato imediato
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Formulários inteligentes para captar leads
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Estrutura otimizada para Google e para conversão
                    </li>
                </ul>

                <div class="sol-ideal">
                    <div class="sol-ideal__label">Foco de Atuação</div>
                    <div class="sol-ideal__list">Profissionais e negócios locais que precisam aumentar autoridade, visibilidade e conquistar mais clientes.</div>
                </div>

                <div class="sol-price">
                    <div class="sol-price__row">
                        <span class="sol-price__de">DE</span>
                        <span class="sol-price__original">R$ 1.697</span>
                    </div>
                    <div class="sol-price__row" style="margin-top: 4px;">
                        <span class="sol-price__por">POR</span>
                        <div class="sol-price__value"><span class="sol-price__currency">R$</span>997</div>
                    </div>
                </div>

                <a href="{{ app()->getLocale() === 'en' ? '/en#agendamento' : '/#agendamento' }}" class="sol-cta">
                    Solicitar Proposta <span class="sol-cta__arrow">→</span>
                </a>
                <p class="sol-price__monthly">+ R$60/mês (domínio, hospedagem e suporte básico)</p>
            </div>

            {{-- ============ PLANO 02 — Gestão Inteligente (FEATURED) ============ --}}
            <div class="sol-card sol-card--featured sol-reveal" onclick="openSolutionModal('gestao-inteligente')">
                ...
                <p class="sol-card__phrase">"Pare de perder dinheiro com desorganização. Automatize tudo."</p>
                <p class="sol-card__desc">Sistema completo que elimina processos manuais e coloca o controle financeiro e operacional na palma da sua mão.</p>
                ...
                <ul class="sol-features">
                    ...
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Agendamentos 24h automáticos via link e WhatsApp
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Recebimentos via PIX integrados
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Base de clientes organizada com histórico completo
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Relatórios financeiros e de faturamento líquido
                    </li>
                </ul>

                <div class="sol-ideal">
                    <div class="sol-ideal__label">Foco de Atuação</div>
                    <div class="sol-ideal__list">Negócios que querem profissionalizar o atendimento, automatizar o faturamento e ter controle total da operação.</div>
                </div>

                <div class="sol-price">
                    <div class="sol-price__row">
                        <span class="sol-price__de">DE</span>
                        <span class="sol-price__original">R$ 3.200</span>
                    </div>
                    <div class="sol-price__row" style="margin-top: 4px;">
                        <span class="sol-price__por">POR</span>
                ...
                <button class="sol-cta sol-cta--featured" type="button">
                    Ver Demonstração <span class="sol-cta__arrow">→</span>
                </button>
                <p class="sol-price__monthly">+ R$60/mês (domínio, hospedagem e suporte básico)</p>
            </div>
            ...
            <div class="sol-card sol-reveal">
                ...
                <p class="sol-card__phrase">"Sua equipe organizada, produtiva e escalando junto."</p>
                <p class="sol-card__desc">Plataforma multiusuário para equipes que desejam crescer com controle, performance e segurança.</p>

                <ul class="sol-features">
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Múltiplos usuários com perfis e permissões
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Agenda compartilhada com distribuição inteligente
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Split de pagamentos (PIX e Cartão de Crédito)
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Relatórios individuais de produtividade e comissão
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Gestão de clientes e serviços da equipe
                    </li>
                </ul>

                <div class="sol-ideal">
                    <div class="sol-ideal__label">Foco de Atuação</div>
                    <div class="sol-ideal__list">Empresas que possuem equipes e precisam manter agenda, performance, produtividade e lucratividade.</div>
                </div>

                <div class="sol-price">
                    <div class="sol-price__row">
                        <span class="sol-price__de">DE</span>
                        <span class="sol-price__original">R$ 4.200</span>
                    </div>
                    <div class="sol-price__row" style="margin-top: 4px;">
                        <span class="sol-price__por">POR</span>
            ...
            <div class="sol-card sol-card--enterprise sol-reveal">
                ...
                <p class="sol-card__phrase">"Quando o padrão não resolve. Construímos o que o seu negócio realmente precisa."</p>
                <p class="sol-card__desc">Engenharia de software dedicada para operações complexas que exigem soluções exclusivas e integrações avançadas.</p>
                ...
                <ul class="sol-features">
                    <li>
                        ...
                        Sistema 100% sob medida
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="stroke: #818cf8;"><polyline points="20 6 9 17 4 12"/></svg>
                        Integração nativa com APIs, ERPs e sistemas legados
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="stroke: #818cf8;"><polyline points="20 6 9 17 4 12"/></svg>
                        Arquitetura escalável para alto volume e performance
                    </li>
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="stroke: #818cf8;"><polyline points="20 6 9 17 4 12"/></svg>
                    ...
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="stroke: #818cf8;"><polyline points="20 6 9 17 4 12"/></svg>
                        Tecnologia de ponta aplicada ao seu modelo de negócio
                    </li>
                </ul>

                <div class="sol-ideal">
                    <div class="sol-ideal__label">Foco de Atuação</div>
                    <div class="sol-ideal__list">Empresas de grande porte, franquias, indústrias e operações que exigem alta performance e arquitetura dedicada.</div>
                </div>

                <div class="sol-price">
                    <div class="sol-price__label">Arquitetura Dedicada</div>
                    <div class="sol-price__value" style="color: #818cf8; font-size: 1.2rem; font-family: 'Orbitron', sans-serif;">Sob Consulta</div>
                </div>

                <a href="{{ app()->getLocale() === 'en' ? '/en#agendamento' : '/#agendamento' }}" class="sol-cta sol-cta--enterprise">
                    Falar com Especialista <span class="sol-cta__arrow">→</span>
                </a>
                <p class="sol-price__monthly" style="color: #3f3f46;">Infraestrutura e suporte sob consulta</p>
            </div>
                ...
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <span class="text-xs font-bold uppercase tracking-widest text-white" style="font-family: 'Orbitron', sans-serif;">Infraestrutura e Suporte</span>
                        </div>
                        <p class="text-[11px] text-zinc-500 mb-4 max-w-lg leading-relaxed">
                            Cobramos um valor fixo mensal que garante que o seu negócio esteja sempre no ar, seguro e funcionando perfeitamente.
                        </p>
                        <div class="flex flex-wrap gap-x-5 gap-y-2">
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="text-[11px] text-zinc-400">Domínio profissional</span>
                            </div>
                            <div class="flex items-center gap-1.5">
                                <svg class="w-3 h-3 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#a855f7" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                                <span class="text-[11px] text-zinc-400">Hospedagem premium</span>
                            </div>
                            <div class="flex items-center gap-1.5">
                                <svg class="w-3 h-3 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#a855f7" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                                <span class="text-[11px] text-zinc-400">SSL e segurança</span>
                            </div>
                            <div class="flex items-center gap-1.5">
                                <svg class="w-3 h-3 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#a855f7" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                                <span class="text-[11px] text-zinc-400">Manutenções e ajustes</span>
                            </div>
                            <div class="flex items-center gap-1.5">
                                <svg class="w-3 h-3 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#a855f7" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                                <span class="text-[11px] text-zinc-400">Suporte contínuo</span>
                            </div>
                        </div>
                    </div>
                    <div class="lg:pl-8 lg:border-l border-white/[0.06] text-left lg:text-right flex-shrink-0">
                        <div class="text-[9px] font-bold uppercase tracking-[0.2em] text-zinc-500 mb-1" style="font-family: 'Orbitron', sans-serif;">Investimento Fixo</div>
                        <div style="font-family: 'Orbitron', sans-serif; font-weight: 900; font-size: 1.9rem; letter-spacing: 0.02em; color: #fff; line-height: 1;">
                            <span style="font-size: 1rem; color: #a855f7; margin-right: 2px;">R$</span>60<span style="font-size: 0.9rem; color: #71717a; font-weight: 700;">/mês</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mt-12 sol-reveal">
            <p class="text-zinc-500 text-sm mb-5">Precisa de algo fora do padrão?</p>
            <a href="{{ app()->getLocale() === 'en' ? '/en#agendamento' : '/#agendamento' }}" class="inline-flex items-center gap-2 px-7 py-3 rounded-full text-xs font-bold bg-gradient-to-r from-purple-600 to-indigo-600 text-white uppercase tracking-widest transition-all hover:scale-105 shadow-[0_4px_20px_rgba(168,85,247,0.25)]" style="font-family: 'Orbitron', sans-serif;">
                Alinhar Projeto Exclusivo <span>→</span>
            </a>
        </div>
...
<div id="sol-modal"
    ...
    <div class="sol-modal__panel w-full max-w-6xl relative">
        ...
        <button id="sol-modal-close"
                ...
                aria-label="Fechar demonstração">✕</button>
        ...
        <div class="sol-modal__hero">
            ...
            <div class="relative z-10">
                ...
                <h2 id="sol-modal-title" class="sol-modal__hero-title">
                    Gestão <span style="color:transparent;background:linear-gradient(92deg,#c084fc,#818cf8);-webkit-background-clip:text;background-clip:text;">Inteligente</span>
                </h2>
                <p class="sol-modal__hero-subtitle">
                    Automatize agendamentos, pagamentos e gestão operacional em uma única plataforma e profissionalize cada detalhe do seu negócio.
                </p>
            </div>
        </div>
        ...
        <div class="sol-modal__body">
            ...
            <div class="mb-8">
                <div class="sol-modal__section-label">
                    <span class="label-text">O que você ganha</span>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                    ...
                    <div class="sol-benefit">
                        ...
                        <div>
                            <div class="sol-benefit__title">Agendamento<br>Automatizado</div>
                            <div class="sol-benefit__desc">24h sem esforço</div>
                        </div>
                    </div>
                    ...
                    <div class="sol-benefit">
                        ...
                        <div>
                            <div class="sol-benefit__title">Painel<br>Administrativo</div>
                            <div class="sol-benefit__desc">Visão completa</div>
                        </div>
                    </div>
                    ...
                    <div class="sol-benefit">
                        ...
                        <div>
                            <div class="sol-benefit__title">PIX<br>Integrado</div>
                            <div class="sol-benefit__desc">Receba na hora</div>
                        </div>
                    </div>
                    ...
                    <div class="sol-benefit">
                        ...
                        <div>
                            <div class="sol-benefit__title">Controle<br>Financeiro</div>
                            <div class="sol-benefit__desc">Sem surpresas</div>
                        </div>
                    </div>
                    ...
                    <div class="sol-benefit">
                        ...
                        <div>
                            <div class="sol-benefit__title">Relatórios<br>em Tempo Real</div>
                            <div class="sol-benefit__desc">Dados ao vivo</div>
                        </div>
                    </div>
                    ...
                    <div class="sol-benefit">
                        ...
                        <div>
                            <div class="sol-benefit__title">Gestão de<br>Clientes</div>
                            <div class="sol-benefit__desc">Histórico total</div>
                        </div>
                    </div>
                    ...
                    <div class="sol-benefit">
                        ...
                        <div>
                            <div class="sol-benefit__title">Atendimento<br>Profissional</div>
                            <div class="sol-benefit__desc">Experiência top</div>
                        </div>
                    </div>
                    ...
                    <div class="sol-benefit">
                        ...
                        <div>
                            <div class="sol-benefit__title">Escalabilidade<br>do Negócio</div>
                            <div class="sol-benefit__desc">Cresça sem limites</div>
                        </div>
                    </div>
            ...
            <div class="sol-modal__section-label" style="margin-bottom:20px;">
                ...
                <span class="label-text">Demonstração em Vídeo</span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div class="sol-video-card">
                        <div class="sol-video-header">
                            ...
                            <div>
                                <div class="sol-video-title">Modelo Site</div>
                                <div class="sol-video-desc">Homepage do cliente</div>
                            </div>
                        </div>
                        <p class="sol-video-caption">A página principal que o cliente entra - design premium, apresentação dos serviços e botão direto para o agendamento, além da visualização dos tipos de serviços.</p>
                    ...
                    <div class="sol-video-card">
                        <div class="sol-video-header">
                            ...
                            <div>
                                <div class="sol-video-title">Agendar</div>
                                <div class="sol-video-desc">Fluxo de agendamento</div>
                            </div>
                        </div>
                        <p class="sol-video-caption">O cliente final escolhe o serviço, a data e o horário - tudo em poucos cliques, sem precisar ligar ou mandar mensagem.</p>
                        <div class="sol-video-wrap">
                            <video class="sol-demo-video" muted loop playsinline preload="none">
                    ...
                    <div class="sol-video-card sol-video-card--mobile sm:col-span-1">
                        <div class="sol-video-header">
                            ...
                            <div>
                                ...
                                <div class="sol-video-desc">Versão celular do cliente</div>
                            </div>
                        </div>
                        <p class="sol-video-caption">Como o site aparece no celular: responsivo, rápido e com a mesma experiência premium do desktop.</p>
        ...
        <div class="sol-modal__footer">
            <p class="text-[11px] text-zinc-600">Projeto real: Barbearia Nathan do Corte</p>
            <a href="{{ app()->getLocale() === 'en' ? '/en#agendamento' : '/#agendamento' }}"
               ...
               onclick="closeSolutionModal()">
                Solicitar demonstração ao vivo <span>→</span>
            </a>
            <div class="text-[11px] text-zinc-600 mt-1">A partir de <strong class="text-zinc-400" style="font-family:'Orbitron',sans-serif;">R$2.200</strong></div>
        </div>
